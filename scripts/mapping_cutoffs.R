...
# set directory
setwd("~/Documents/ESPOD/Analyses/Project_latinbiota/mapping/uhgg-combined/raw")
...
# use count data
bwa.counts = data.frame(t(read_bwa("bwa_counts-unique.csv")), check.names = FALSE)
...
write.table(bwa.binary, file="../summary_tables/euproks-above0_counts-transf_all.csv", sep=",", quote=FALSE, row.names=FALSE)
