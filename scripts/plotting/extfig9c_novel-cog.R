...
cogs = read.delim("prokaryotes/functions/annotations/eggNOG_annotations.tsv", header=FALSE, stringsAsFactors = FALSE)[,c(1,7)]
...
ggsave("../../../Publications/2022-Latinbiota/Figures/extfig9/cog_enriched.pdf", height=7, width=8)
