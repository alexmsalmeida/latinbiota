...
ggarrange(ggarrange(amr.prop.cont, stack.cont, amr.prop, nrow=1, legend = "none", 
                    widths=c(0.9,1.5,1), labels = c("a", "b", "c"), font.label = list(size=20)), 
          ggarrange(amr.classes.legend, amr.prop.legend, nrow=1, widths=c(1.5,1)), nrow=2, heights=c(5,1))
ggsave("../../../Publications/2022-Latinbiota/Figures/extfig9/ExtendedData_Figure9.pdf", height=7, width=13)
