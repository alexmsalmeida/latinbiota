...
kegg.ontology = read.delim("prokaryotes/functions/kegg_ontology/kegg_classes.tsv", header=FALSE, stringsAsFactors = FALSE, sep="\t")
...
file = "prokaryotes/functions/annotations/KOFam_annotations.tsv"
...
ggsave("../../../Publications/2022-Latinbiota/Figures/extfig9/kegg_enriched.pdf", height=7, width=8)
