...
bwa.data = as.data.frame(read.csv("viruses/mapping/summary_tables/viruses-above0_binary_latinbiota-all.csv", row.names=1, check.names=FALSE, stringsAsFactors = FALSE)); variable = "Country"
...
ggsave(file="../../../Publications/2022-Latinbiota/Figures/extfig7/upset_viruses_latinbiota-all.pdf", height=9, width=10)
