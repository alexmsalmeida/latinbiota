...
host.bacteria = read.delim("viruses/virus_host_all.tsv", header=TRUE, stringsAsFactors = FALSE)
host.bacteria.tax.filt = read.delim("viruses/virus_host_summary.tsv", header=TRUE, stringsAsFactors = FALSE)
...
ggsave("../../../Publications/2022-Latinbiota/Figures/figure5/host_counts.pdf", width=8, height=5)
