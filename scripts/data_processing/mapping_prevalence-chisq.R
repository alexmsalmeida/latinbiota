...
bwa.data = as.data.frame(read.csv("prokaryotes/mapping/summary_tables/euproks-above0_binary_world-adult-healthy.csv", 
...
write.table(bwa.fi, file="prokaryotes/mapping/chisq_euproks_latinbiota.tsv", sep="\t", quote=FALSE, row.names=FALSE)
